...
Stream<List<Map<String, dynamic>>> recipeSearchResult() {
  final value = supabase.from('userRecipe').stream(primaryKey: ['id']);
  print(value);
  return value;
}
...
Padding ModifiedProfileCard(BuildContext context,Map<String, dynamic> note) {
  // Map<String, dynamic> note = {
  //   'title': 'title',
  //   'description': 'description',
  //   'kcal': 'kcal',
